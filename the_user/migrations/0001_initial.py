    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ifsc_code', models.CharField(blank=True, db_index=True, max_length=11, null=True, unique=True)),
                ('micr', models.CharField(blank=True, max_length=9, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pan', fernet_fields.fields.EncryptedCharField(blank=True, default='', max_length=10, validators=[django.core.validators.MaxLengthValidator(10)])),
                ('aadhaar_number', fernet_fields.fields.EncryptedCharField(blank=True, default='', max_length=12, validators=[django.core.validators.MaxLengthValidator(10)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('H', 'Home'), ('M', 'Mobile'), ('O', 'Office')], default='M', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('P', 'Personal'), ('O', 'Official')], max_length=1)),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('modified_date', models.DateTimeField(auto_now=True)),
                ('email_address', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='type', to='account.emailaddress')),
            ],
        ),
        migrations.CreateModel(
            name='Card',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('D', 'Debit'), ('C', 'Credit')], default='D', max_length=1)),
                ('name_on_card', models.CharField(max_length=100)),
                ('card_number', fernet_fields.fields.EncryptedCharField(max_length=20, validators=[django.core.validators.RegexValidator(message='Please enter a valid Card number (16 to 20 numeric digits)', regex='^(?:4[0-9]{12}(?:[0-9]{3})?|[25][1-7][0-9]{14}|6(?:011|5[0-9][0-9])[0-9]{12}|3[47][0-9]{13}|3(?:0[0-5]|[68][0-9])[0-9]{11}|(?:2131|1800|35\\d{3})\\d{11})$')])),
                ('expiry_date', models.CharField(max_length=5)),
                ('cvv', fernet_fields.fields.EncryptedIntegerField(validators=[django.core.validators.MaxValueValidator(9999)])),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('modified_date', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='booleansettings', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['user', 'key'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('S', 'Saving'), ('C', 'CURRENT')], default='C', max_length=1)),
                ('bank_name', models.CharField(max_length=100)),
                ('holder_name', models.CharField(max_length=100)),
                ('account_number', fernet_fields.fields.EncryptedCharField(max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('H', 'Home'), ('S', 'Shipping'), ('O', 'Office'), ('B', 'Billing')], default='H', max_length=1)),
